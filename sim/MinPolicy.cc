...
bool MinPolicy::allocateTokensToJobs(std::list<Job*>& jobPtrList, token_t totalNumOfTokens) {
	...
	(*lastJobPtr)->numOfTokens = (*lastJobPtr)->returnFunc->minX;
...
void MinPolicy::reallocateTokensToJobs(std::list<Job*>& jobPtrList, token_t totalNumOfTokens) {
	// do nothing
}
